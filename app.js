...
// Sanitize inputs against MongoDB Operator Injection
...
const connectSrcUrls = ["https://maps.googleapis.com/"];
const fontSrcUrls = [
  "https://cdn.jsdelivr.net/",
  "https://cdnjs.cloudflare.com/",
  "https://fonts.googleapis.com/",
...
app.use((req, res, next) => {
  // Default bench image
  res.locals.defaultImage =
    "https://res.cloudinary.com/dbx3a0ync/image/upload/v1659867275/Benchmate/default_msyo4m.png";
